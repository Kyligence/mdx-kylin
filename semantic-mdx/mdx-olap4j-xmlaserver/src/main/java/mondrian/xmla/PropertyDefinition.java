...
public enum PropertyDefinition {
    ...
    AxisFormat(RowsetDefinition.Type.Enumeration, Olap4jUtil.enumSetAllOf(XmlaConstants.AxisFormat.class),
            XmlaConstants.Access.Write, "", XmlaConstants.Method.EXECUTE,
    ...
    BeginRange(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Write, "-1", XmlaConstants.Method.EXECUTE,
    ...
    Catalog(RowsetDefinition.Type.String, null, XmlaConstants.Access.ReadWrite, "",
    ...
    Content(RowsetDefinition.Type.EnumString, Olap4jUtil.enumSetAllOf(XmlaConstants.Content.class),
            XmlaConstants.Access.Write, XmlaConstants.Content.DEFAULT.name(), XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    DataSourceInfo(RowsetDefinition.Type.String, null, XmlaConstants.Access.ReadWrite, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "A string containing provider specific information, required to access the data source."),

    // Mondrian-specific extension to XMLA.
    Deep(RowsetDefinition.Type.Boolean, null, XmlaConstants.Access.ReadWrite, "", XmlaConstants.Method.DISCOVER,
    ...
    // Mondrian-specific extension to XMLA.
    EmitInvisibleMembers(RowsetDefinition.Type.Boolean, null, XmlaConstants.Access.ReadWrite, "",
            XmlaConstants.Method.DISCOVER, "Whether to include members whose VISIBLE property is false, or "
                    + "measures whose MEASURE_IS_VISIBLE property is false."),

    EndRange(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Write, "-1", XmlaConstants.Method.EXECUTE,
    ...
    Format(RowsetDefinition.Type.EnumString, Olap4jUtil.enumSetAllOf(XmlaConstants.Format.class),
            XmlaConstants.Access.Write, "Native", XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    LocaleIdentifier(RowsetDefinition.Type.UnsignedInteger, null, XmlaConstants.Access.ReadWrite, "None",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    MDXSupport(RowsetDefinition.Type.EnumString, Olap4jUtil.enumSetAllOf(XmlaConstants.MdxSupport.class),
            XmlaConstants.Access.Read, "Core", XmlaConstants.Method.DISCOVER,
    ...
    Password(RowsetDefinition.Type.String, null, org.olap4j.metadata.XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    ProviderName(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read, "olap4j-xmlaserver",
            XmlaConstants.Method.DISCOVER, "The XML for Analysis Provider name."),

    ProviderVersion(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read, "0.1", XmlaConstants.Method.DISCOVER,
            "The version of the Mondrian XMLA Provider"),

    DBMSVersion(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read, "11.0.7001.0", XmlaConstants.Method.DISCOVER,
            "The version of the Mondrian XMLA Provider"),
     ...
     */
    ResponseMimeType(RowsetDefinition.Type.String, null, XmlaConstants.Access.ReadWrite, "None",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    StateSupport(RowsetDefinition.Type.EnumString, Olap4jUtil.enumSetAllOf(XmlaConstants.StateSupport.class),
            XmlaConstants.Access.Read, "None", XmlaConstants.Method.DISCOVER,
    ...
    Timeout(RowsetDefinition.Type.UnsignedInteger, null, XmlaConstants.Access.ReadWrite, "Undefined",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "A numeric time-out specifying in seconds the amount of time to wait for a request to be successful."),

    UserName(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, "Returns the UserName the server associates with the command.\n"
    ...
    VisualMode(RowsetDefinition.Type.Enumeration, Olap4jUtil.enumSetAllOf(XmlaConstants.VisualMode.class),
            XmlaConstants.Access.Write, Integer.toString(XmlaConstants.VisualMode.VISUAL.ordinal()),
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    // mondrian-specific property for advanced drill-through
    AdvancedFlag(RowsetDefinition.Type.Boolean, null, XmlaConstants.Access.Read, "false",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, ""),

    // excel support
    DbpropMsmdSubqueries(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.ReadWrite, "2",
            XmlaConstants.Method.DISCOVER, "A bitmask that determines the behavior of subqueries."),

    DbpropMsmdActivityID(RowsetDefinition.Type.String, null, XmlaConstants.Access.Read, "10086",
            XmlaConstants.Method.DISCOVER,
            "A string value that can be set by a client on a session to trace multiple query requests to the server"),

    DbpropMsmdOptimizeResponse(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.ReadWrite, "9",
            XmlaConstants.Method.DISCOVER,
            " A bitmask that indicates which of the following query response optimizations are enabled"),

    DbpropMsmdMDXCompatibility(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.ReadWrite, "1",
            XmlaConstants.Method.DISCOVER, "DbpropMsmdMDXCompatibility"),

//    MdpropMdxDrillFunctions(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Read, "3",
//            XmlaConstants.Method.DISCOVER,
//            "A bitmask indicating support for drilldown and drillup groups of functions. "),
//
//    MdpropMdxDdlExtensions(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Read, "",
//            XmlaConstants.Method.DISCOVER, "A bitmask that indicates one or more of cube capability"),

    /**
     * 指示对 MDX 中子查询的支持级别。
     * #  默认值：
     * #     值 63 是此属性在 SQL Server 2014 中的默认值。
     * #     值 31 是此属性在 SQL Server 2008 R2 和 SQL Server 2012 中的默认值。
     * #     值 15 是此属性在 SQL Server 2008 中的默认值
     * #     值 3  是 SQL Server 2005 Analysis Services 的默认值。
     * #  可选，只读整数属性	此属性的有效值是从以下值中生成的位掩码：
     ...
     */
    MdpropMdxSubqueries(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Read, "2",
            XmlaConstants.Method.DISCOVER, "A bitmask that indicates the level of support for subqueries in MDX"),

//    MdpropMdxNamedSets(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.Read, "1",
//            XmlaConstants.Method.DISCOVER, "A bitmask that indicates the type of support for named sets"),

    MdxMissingMemberMode(RowsetDefinition.Type.String, null, XmlaConstants.Access.ReadWrite, "Error",
            XmlaConstants.Method.DISCOVER,
            "Indicates whether missing members are ignored in MDX statements."),

    SafetyOptions(RowsetDefinition.Type.Integer, null, XmlaConstants.Access.ReadWrite, "2",
            XmlaConstants.Method.DISCOVER, "SafetyOptions"),
    ;
    ...
    /** it smells. is needed to support excel*/
    public volatile String value;
    final String description;
    private ThreadLocal<String> currentCatalog = new ThreadLocal<String>();

    PropertyDefinition(RowsetDefinition.Type type, Set<? extends Enum> enumSet, XmlaConstants.Access access,
    ...
    /** Excel support. Need to set current catalog.
     * it smells.*/
