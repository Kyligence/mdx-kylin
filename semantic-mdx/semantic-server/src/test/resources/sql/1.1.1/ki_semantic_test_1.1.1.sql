...
) ENGINE=InnoDB AUTO_INCREMENT=2251 DEFAULT CHARSET=utf8 COMMENT='calculation measure table';

-- ----------------------------
-- Records of calculate_measure
-- ----------------------------
BEGIN;
INSERT INTO `calculate_measure` VALUES (4, 4, 'GMV', '[Measures].[GMV_销售额] + 1000', '$#,###', '', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1);
...
CREATE TABLE `common_dim_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8573 DEFAULT CHARSET=utf8 COMMENT='common dimension among models';
...
CREATE TABLE `custom_hierarchy` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6739 DEFAULT CHARSET=utf8 COMMENT='custom hierarchy table';
...
CREATE TABLE `dataset` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7684 DEFAULT CHARSET=utf8 COMMENT='semantic-dataset';
...
CREATE TABLE `dim_table_model_rel` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16080 DEFAULT CHARSET=utf8 COMMENT='the relationshiop beteween dimension table and model';
...
CREATE TABLE `named_dim_col` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40620 DEFAULT CHARSET=utf8 COMMENT='table column alias and type info';

-- ----------------------------
-- Records of named_dim_col
-- ----------------------------
BEGIN;
INSERT INTO `named_dim_col` VALUES (13, 4, 'snowflake_inner_hierarcy_cube', 'SELLER_COUNTRY', 'NAME', 'NAME', 0, 'VARCHAR', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (14, 4, 'snowflake_inner_hierarcy_cube', 'BUYER_COUNTRY', 'NAME', 'NAME', 0, 'VARCHAR', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (15, 4, 'snowflake_inner_hierarcy_cube', 'BUYER_ACCOUNT', 'ACCOUNT_BUYER_LEVEL', 'ACCOUNT_BUYER_LEVEL', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (16, 4, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'CATEG_LVL2_NAME', 'CATEG_LVL2_NAME', 0, 'VARCHAR', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (17, 4, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'CATEG_LVL3_NAME', 'CATEG_LVL3_NAME', 0, 'VARCHAR', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (18, 4, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'META_CATEG_NAME', 'META_CATEG_NAME', 0, 'VARCHAR', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (19, 5, 'snowflake_inner_hierarcy_cube', 'SELLER_COUNTRY', 'NAME', 'NAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (20, 5, 'snowflake_inner_hierarcy_cube', 'BUYER_COUNTRY', 'NAME', 'NAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (21, 5, 'snowflake_inner_hierarcy_cube', 'BUYER_ACCOUNT', 'ACCOUNT_BUYER_LEVEL', 'ACCOUNT_BUYER_LEVEL', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (22, 5, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'CATEG_LVL2_NAME', 'CATEG_LVL2_NAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (23, 5, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'CATEG_LVL3_NAME', 'CATEG_LVL3_NAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (24, 5, 'snowflake_inner_hierarcy_cube', 'KYLIN_CATEGORY_GROUPINGS', 'META_CATEG_NAME', 'META_CATEG_NAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1517, 1454, 'EJ_Cube1', 'PAF_DIM_CAL', 'DIMDATE', 'DIMDATE', 0, 'DATE', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1518, 1454, 'EJ_Cube1', 'PAF_DIM_CAL', 'DIMWEEKDAY', 'DIMWEEKDAY', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1519, 1454, 'EJ_Cube1', 'PAF_DIM_FLIGHT', 'DIMFLIGHTCODE', 'DIMFLIGHTCODE', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1520, 1454, 'EJ_Cube1', 'PAF_DIM_FLIGHT', 'DIMFLIGHTDATE', 'DIMFLIGHTDATE', 0, 'DATE', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1521, 1454, 'EJ_Cube1', 'PAF_DIM_FLIGHT', 'DIMFLIGHTID', 'DIMFLIGHTID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1522, 1454, 'EJ_Cube1', 'PAF_FACT_LEG', 'DIMFLIGHTID', 'DIMFLIGHTID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1523, 1454, 'EJ_Cube1', 'PAF_FACT_LEG', 'FACTLEGID', 'FACTLEGID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1524, 1454, 'EJ_Cube2', 'PAF_DIM_PASSENGER', 'DIMPASSDOJ', 'DIMPASSDOJ', 0, 'DATE', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1525, 1454, 'EJ_Cube2', 'PAF_DIM_PASSENGER', 'DIMPASSID', 'DIMPASSID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1526, 1454, 'EJ_Cube2', 'PAF_DIM_PASSENGER', 'DIMPASSNAME', 'DIMPASSNAME', 0, 'VARCHAR', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1527, 1454, 'EJ_Cube2', 'PAF_FACT_TRIP', 'DIMFLIGHTID', 'DIMFLIGHTID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1528, 1454, 'EJ_Cube2', 'PAF_FACT_TRIP', 'DIMPASSID', 'DIMPASSID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1529, 1454, 'EJ_Cube2', 'PAF_FACT_TRIP', 'FACTTRIPID', 'FACTTRIPID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1530, 1454, 'EJ_Cube4', 'PAF_FACT_BOOKING', 'BOOKEDDATE', 'BOOKEDDATE', 0, 'TIMESTAMP', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1531, 1454, 'EJ_Cube4', 'PAF_FACT_BOOKING', 'DIMFLIGHTID', 'DIMFLIGHTID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1532, 1454, 'EJ_Cube4', 'PAF_FACT_BOOKING', 'DIMPASSID', 'DIMPASSID', 0, 'INTEGER', '', 1, NULL, NULL);
INSERT INTO `named_dim_col` VALUES (1533, 1454, 'EJ_Cube4', 'PAF_FACT_BOOKING', 'FACTBOOKINGID', 'FACTBOOKINGID', 0, 'INTEGER', '', 1, NULL, NULL);
COMMIT;
...
CREATE TABLE `named_dim_table` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18327 DEFAULT CHARSET=utf8 COMMENT='dim table alias and type info';
...
CREATE TABLE `named_measure` (
  ...
  `visible_flag` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=22323 DEFAULT CHARSET=utf8 COMMENT='measure alias info';

-- ----------------------------
-- Records of named_measure
-- ----------------------------
BEGIN;
INSERT INTO `named_measure` VALUES (8, 4, 'snowflake_inner_hierarcy_cube', '_COUNT_', '个数', 'COUNT', 'bigint', 'constant', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1);
INSERT INTO `named_measure` VALUES (9, 4, 'snowflake_inner_hierarcy_cube', 'GMV_销售额', 'GMV_销售额', 'SUM', 'decimal(19,4)', 'KYLIN_SALES.PRICE', '', 1);
INSERT INTO `named_measure` VALUES (10, 4, 'snowflake_inner_hierarcy_cube', '销售数量总计', '销售数量总计', 'SUM', 'bigint', 'KYLIN_SALES.ITEM_COUNT', '{\"visible\":[{\"name\":\"ADMIN\",\"type\":\"user\"}]}', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=430 DEFAULT CHARSET=utf8 COMMENT='named set info';

-- ----------------------------
-- Records of named_set
-- ----------------------------
BEGIN;
INSERT INTO `named_set` VALUES (3, 4, 'Top CA Cities', 'TopCount([CA Cities], 2, [Measures].[Unit Sales])', 'named-set', '{\"visible\":[{\"name\":\"admin\",\"type\":\"user\"}]}', '', 1);
COMMIT;
