...
public enum ErrorCode {
    ...
    EXECUTE_PARAMETER_NOT_ENABLED("MDX-04020011",
            "Can't use the parameter \"EXECUTE_AS_USER_ID\" now. Please contact your system admin to enable it in Kylin MDX."),
    ...
    EXECUTE_PARAMETER_NOT_FOUND("MDX-04020014",
            "Can't find the user specified in parameter \"EXECUTE_AS_USER_ID\" in Kylin. Please contact your system admin and make sure you have access to Kylin MDX."),
    EXECUTE_NOT_ENOUGH_PERMISSION("MDX-04020015",
            "The user does not have enough permission to perform user delegation. Please make the user is at least a project admin in Kylin, and have all access to the dataset in Kylin MDX.");
