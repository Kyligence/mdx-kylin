...
public class ParameterExpr extends ExpBase {
    ...
    public String toStringInStack(ArrayStack<QueryPart> stack, int pos) {
        ...
        buf.append(" ").append("name=").append(parameter.getName());
        buf.append(" ").append("type=").append(parameter.getType());
        buf.append(" ").append("defaultExp=");
        addExp(parameter.getDefaultExp(), buf, stack, pos);
        buf.append(" ").append("description=").append(parameter.getDescription());
        buf.append(" >");
        return buf.toString();
    }
}
