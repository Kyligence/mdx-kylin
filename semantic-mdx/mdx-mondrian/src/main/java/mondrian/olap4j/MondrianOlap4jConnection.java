...
public abstract class MondrianOlap4jConnection implements OlapConnection {
    ...
    public PreparedOlapStatement prepareOlapStatement(String mdx)
        ...
        final MondrianOlap4jPreparedStatement preparedStatement = factory.newPreparedStatement(mdx, this);
    ...
    Type toOlap4j(mondrian.olap.type.Type type) {
        ...
        } else if (type instanceof mondrian.olap.type.EmptyType) {
            return new NullType();
        } else {
            throw new UnsupportedOperationException();
        }
    ...
    private static class MondrianToOlap4jNodeConverter {
        ...
        private ParseTreeNode toOlap4j(Exp exp) {
            ...
            if (exp instanceof NamedSetExpr) {
                NamedSetExpr namedSetExpr = (NamedSetExpr)exp;
                return toOlap4j(namedSetExpr.getNamedSet().getExp());
            }
