...
public class PropertyUtil {
    ...
    private void generate() {
        final File xmlFile =
            new File("mdx-mondrian/src/main/prop/mondrian/olap", "MondrianProperties.xml");
        final File javaFile =
            new File(
                "mdx-mondrian/target/generated-sources/prop/mondrian/olap",
