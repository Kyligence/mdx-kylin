...
public class Format {
    ...
    static class LiteralFormat extends BasicFormat
    {
        ...
        void format(double d, StringBuilder buf) {
            if (RolapUtil.DEFAULT_FORMAT_STRING.equalsIgnoreCase(s)) {
                buf.append(d);
                return;
            }
            buf.append(s);
    ...
    private enum MacroToken {
        ...
        static {
            for (MacroToken macroToken : values()) {
                MAP.put(macroToken.token.toUpperCase(), macroToken);
            }
        }
        ...
        static String expand(FormatLocale locale, String formatString) {
            final MacroToken macroToken = MAP.get(formatString.toUpperCase());
            if (macroToken == null) {
                return formatString;
            }
