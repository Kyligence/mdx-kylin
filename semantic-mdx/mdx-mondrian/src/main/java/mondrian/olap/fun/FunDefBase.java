...
public abstract class FunDefBase extends FunUtil implements FunDef {
    ...
    public Exp createCall(Validator validator, Exp[] args) {
        ...
        if (type == null) {
            throw validator.getPrintStackEx(Util.newInternal("could not derive type"));
        }
    ...
    public Type getResultType(Validator validator, Exp[] args) {
        ...
        throw validator.getPrintStackEx(Util.newInternal(
    ...
    public boolean equals(Object o) {
        ...
        FunDefBase that = (FunDefBase) o;
        return flags == that.flags &&
                getReturnCategory() == that.getReturnCategory() &&
                Objects.equals(getName(), that.getName()) &&
                Objects.equals(getSignature(), that.getSignature()) &&
                Objects.equals(getDescription(), that.getDescription()) &&
                Arrays.equals(getParameterCategories(), that.getParameterCategories());
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(flags, getName(), getSignature(), getDescription(), getReturnCategory());
        result = 31 * result + Arrays.hashCode(getParameterCategories());
        return result;
    }
}
