...
/**
 * Definition of subtraction for numeric or measures
 * @author he.liu
 */
public class InfixMinusNumericFunDef extends FunDefBase {

        static final ReflectiveMultiResolver numericMinusResolver =
                new ReflectiveMultiResolver(
                        "-",
                        "<Member> - <Member> / <Tuple> - <Tuple> / <Numeric> - <Numeric>",
                        "Subtracts two measures.",
                        new String[]   {"inmm", "intt", "innn"},
                        InfixMinusNumericFunDef.class);

        public InfixMinusNumericFunDef(FunDef dummyFunDef) {
            super(dummyFunDef);
        }
