...
public class TupleType implements Type {
     ...
     */
    public static void checkHierarchies(MemberType[] memberTypes, Validator validator) {
        for (int i = 0; i < memberTypes.length; i++) {
            ...
            for (int j = 0; j < i; j++) {
                ...
                if (hierarchy != null && hierarchy == hierarchy1) {
                    throw validator.getPrintStackEx(MondrianResource.instance().DupHierarchiesInTuple.ex(
