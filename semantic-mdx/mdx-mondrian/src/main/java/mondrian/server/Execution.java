...
public class Execution {
    ...
    private boolean canFriendlyHandleError;
        ...
        long timeoutIntervalMillis)
    {
        ...
        this.parent = locus == null ? null : locus.execution;
    ...
    public void start() {
        ...
        // queryTiming not be used
        this.queryTiming.init(false);
    ...
    public void canFriendlyHandleError() {
        this.canFriendlyHandleError = true;
    }

    public boolean getCanFriendlyHandleError() {
        return this.canFriendlyHandleError;
    }
