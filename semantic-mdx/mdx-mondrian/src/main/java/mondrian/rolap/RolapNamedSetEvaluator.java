...
{
    private final RolapResultEvaluatorRoot rrer;
    ...
    private void ensureList() {
        if (list != null) {
            if (list == DUMMY_LIST) {
                throw rrer.getResult().slicerEvaluator.newEvalException(
                    null,
        ...
        try {
            ...
            TupleIterable iterable =
                (TupleIterable)
                    rrer.getResult().evaluateExp(
                        calc,
                        rrer.getResult().slicerEvaluator);
