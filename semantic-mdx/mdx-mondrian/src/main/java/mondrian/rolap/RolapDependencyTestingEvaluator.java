...
public class RolapDependencyTestingEvaluator extends RolapEvaluator {
     ...
     */
    public RolapDependencyTestingEvaluator(RolapResult result, int expDeps) {
        ...
        String mdxString)
    {
        ...
        if (dteRoot.getResult().batchingReader.isDirty()) {
            return result;
        }
     ...
     */
    static class DteRoot extends RolapResultEvaluatorRoot {
        final int expDeps;
        int callCount;
        int fakeCallCount;
        int fakeCount;
