...
public class RolapLevel extends LevelBase {
    ...
    RolapLevel(
        ...
        RolapAttribute weightAttribute,
        ...
        Map<String, List<Larders.Resource>> resourceMap)
    {
        ...
        this.weightAttribute = attribute.getDimension().getDimensionType() != org.olap4j.metadata.Dimension.Type.TIME
                ? weightAttribute
                : null;
    ...
    public RolapAttribute getWeightAttribute() {
