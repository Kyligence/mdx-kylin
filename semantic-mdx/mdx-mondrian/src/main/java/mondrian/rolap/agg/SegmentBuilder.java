...
public class SegmentBuilder {
        ...
        if (body instanceof DenseDoubleSegmentBody) {
            ...
            dataSet =
                    new DenseLongSegmentDataset(
                            ...
                            body.getNullValueIndicators());
        } else if (body instanceof DenseDateSegmentBody) {
            dataSet =
                    new DenseDateSegmentDataset(
                            axes,
                            (Date[]) body.getValueArray(),
                            body.getNullValueIndicators());
        } else if (body instanceof DenseBooleanSegmentBody) {
            dataSet =
                    new DenseBooleanSegmentDataset(
                            axes,
                            (Boolean[]) body.getValueArray(),
                            body.getNullValueIndicators());
        } else if (body instanceof DenseTimestampSegmentBody) {
            dataSet =
                    new DenseTimestampSegmentDataset(
                            axes,
                            (Timestamp[]) body.getValueArray(),
                            body.getNullValueIndicators());
        ...
        List<StarPredicate> compoundPredicates)
    {
        ...
        return new Segment(
                ...
                constrainedColumns,
                measure,
                predicateList.toArray(new StarColumnPredicate[0]),
        ...
        Datatype datatype)
    {
        ...
        final SegmentHeader header = new SegmentHeader(
                ...
                firstHeader.getCustomRollupRequirements());
        ...
        Segment segment)
    {
        ...
        return new SegmentHeader(
                ...
                segment.getCustomRollupRequirements());
    }
