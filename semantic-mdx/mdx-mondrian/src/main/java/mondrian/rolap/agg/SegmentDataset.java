...
public interface SegmentDataset extends Iterable<Map.Entry<CellKey, Object>> {
    ...
    /**
     * Returns the value at a given coordinate, as a {@code Date}.
     *
     * @param pos
     * @return
     */
    Date getDate(CellKey pos);

    /**
     * Returns the value at a given coordinate, as a {@code Boolean}.
     *
     * @param pos
     * @return
     */
    Boolean getBoolean(CellKey pos);

    /**
     * Returns the value at a given coordinate, as a {@code Timestamp}.
     *
     * @param pos
     * @return
     */
    Timestamp getTimestamp(CellKey pos);
    ...
    void putValue(int[] pos, Object value);
