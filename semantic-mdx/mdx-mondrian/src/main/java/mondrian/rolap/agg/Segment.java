...
public class Segment {
    ...
    protected final CustomRollupRequirements customRollupRequirements;
    ...
    public SegmentDataset createDataset(
        SegmentAxis[] axes,
        boolean sparse,
        ...
        int size)
    {
        if (sparse) {
            ...
            case DATE:
                return new DenseDateSegmentDataset(axes, size);
            case BOOLEAN:
                return new DenseBooleanSegmentDataset(axes, size);
            case TIMESTAMP:
                return new DenseTimestampSegmentDataset(axes, size);
            default:
    ...
    private boolean matchesInternal(AggregationKey aggKey) {
        return constrainedColumnsBitKey.equals(aggKey.getConstrainedColumnsBitKey())
                ...
                && Objects.equals(
                        customRollupRequirements,
                        aggKey.getCustomRollupRequirements());
    }
