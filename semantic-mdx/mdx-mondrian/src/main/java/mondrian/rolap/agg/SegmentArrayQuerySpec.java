...
public class SegmentArrayQuerySpec extends AbstractQuerySpec {
    ...
    protected String generateMeasureInnerExpression(RolapStar.Measure measure, SqlQueryBuilder queryBuilder) {
        ...
        if (measure.getExpression() == null) {
            ...
            CustomRollupRequirements customRollupRequirements = segment0.getCustomRollupRequirements();
            innerExpression = customRollupRequirements == null
                    ? measure.getExpression().toSql()
                    : customRollupRequirements.getWeightedMeasureExpression(measure, queryBuilder);
        }
        ...
        Map<String, String> groupingSetsAliases)
    {
        ...
        if (customRollupRequirements != null) {
            customRollupRequirements.writeNonQueryingM2MTables(queryBuilder);
        }
    }
