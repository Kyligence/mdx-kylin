...
class SparseSegmentDataset implements SegmentDataset {
    ...
    @Override
    public Date getDate(CellKey pos) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Boolean getBoolean(CellKey pos) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Timestamp getTimestamp(CellKey pos) {
        throw new UnsupportedOperationException();
    }
    ...
    public void putValue(int[] pos, Object value) {
        put(CellKey.Generator.newCellKey(pos), value);
    }
