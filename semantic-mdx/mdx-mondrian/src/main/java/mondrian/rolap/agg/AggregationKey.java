...
public class AggregationKey
{
    ...
    private boolean isM2MAccumulative;
    ...
    public static AggregationKey create(CellRequest request) {
        List<StarPredicate> compoundPredicates = request.getCompoundPredicates();
        return new AggregationKey(
                request.getConstrainedColumnsBitKey(),
                request.getMeasure().getStar(),
                compoundPredicates == null
                        ? Collections.emptyList()
                        : request.getCompoundPredicates(),
                request.getMeasure().isM2MAccumulative(),
    ...
    public final int computeHashCode() {
        return computeHashCode(
                ...
                star,
                compoundPredicateList == null ? null : new AbstractList<BitKey>() {
        ...
        CustomRollupRequirements customRollupRequirements)
    {
        ...
        retCode = Util.hash(retCode, isM2MAccumulative);
        return Util.hash(retCode, customRollupRequirements);
    }
    ...
    public boolean equals(Object other) {
        ...
        return constrainedColumnsBitKey.equals(that.constrainedColumnsBitKey)
            ...
            && isM2MAccumulative == that.isM2MAccumulative
            && Objects.equals(customRollupRequirements, that.customRollupRequirements);
    }
    ...
    public String toString() {
        return star.getFactTable().getTableName()
                ...
                + '\n'
                + (customRollupRequirements == null ? "CustomRollupRequirements()" : customRollupRequirements.toString());
    }
