...
public class RolapCell implements Cell {
    ...
    private boolean preserveRegularFormat;
     ...
     * @param preserveRegularFormat Whether the query client is Excel
     */
    public RolapCell(RolapResult result, int[] pos, CellInfo ci, boolean preserveRegularFormat) {
        this.result = result;
        this.pos = pos;
        this.ci = ci;
        this.preserveRegularFormat = preserveRegularFormat;
    }
        ...
        boolean extendedContext)
    {
        return getDrillThroughSQL(
            new ArrayList<Exp>(), -1, extendedContext);
    }
        ...
        Logger logger)
    {
        ...
        // Generate SQL.
        String sql = getDrillThroughSQL(fields, maxRowCount, extendedContext);
    ...
    public Object getPropertyValue(String propertyName) {
        ...
        if (property != null) {
            ...
            case Property.FORMAT_STRING_ORDINAL:
                ...
                return RolapUtil.processFormatString(ci.formatString, preserveRegularFormat);
