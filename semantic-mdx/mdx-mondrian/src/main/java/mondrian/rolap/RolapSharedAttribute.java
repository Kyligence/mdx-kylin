...
public class RolapSharedAttribute extends RolapAttributeImpl {
    ...
    {
        super(
            name, visible, keyList, nameExp, captionExp, orderByList, valueExp,
    ...
    public RolapAttribute cloneWithNewKeyCols(List<RolapSchema.PhysColumn> keyList, List<RolapSchema.PhysColumn> orderByList) {
        return new RolapSharedAttribute(this.name, this.visible, keyList, this.nameExp, this.captionExp, orderByList, this.valueExp, this.memberFormatter, this.levelType, this.getApproxRowCount());
    }
    ...
    private static class DelegatingAttribute implements RolapAttribute {
        ...
        @Override
        public RolapSchema.PhysColumn getValueExp() {
            return delegate.getValueExp();
        }
        ...
        @Override
        public RolapAttribute cloneWithNewKeyCols(List<RolapSchema.PhysColumn> keyList, List<RolapSchema.PhysColumn> orderByList) {
            return delegate.cloneWithNewKeyCols(keyList, orderByList);
        }
    }
