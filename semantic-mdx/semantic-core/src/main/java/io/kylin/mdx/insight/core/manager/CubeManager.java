...
public interface CubeManager {
    ...
    /**
     * get all cube data name from remote, only KYLIN now
     *
     * @param project mdx project name
     * @return Set<String>
     * @throws SemanticException
     */
    Set<String> getCubeByKylin(String project) throws SemanticException;

    /**
     * get all cube data name from cache, cache is from memory now
     *
     * @param project mdx project name
     * @return Set<String>
     * @throws SemanticException
