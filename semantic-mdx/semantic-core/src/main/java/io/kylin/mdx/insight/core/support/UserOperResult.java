...
public enum UserOperResult {
    ...
    LOGIN_NOT_AUTHORIZED(1001, HttpStatus.SC_UNAUTHORIZED, "User hasn't been authorized in Kylin MDX.", ErrorCode.INACTIVE_USER),
    ...
    USER_LIMIT_EXCEED(1006, HttpStatus.SC_UNAUTHORIZED, "User number reaches Kylin MDX License's max limited number.", ErrorCode.LICENSE_USER_EXCEED_LIMIT),

    KYLIN_MDX_LOGIN_LICENSE_OUTDATED(1007, HttpStatus.SC_UNAUTHORIZED, "Kylin MDX License has expired.", ErrorCode.EXPIRED_LICENSE),
    ...
    NO_CONFIG_USER(1009, HttpStatus.SC_UNAUTHORIZED, "The system lacks user information for syncing Kylin tasks. Please log in to Kylin MDX with a Kylin system administrator account to configure connection information.", ErrorCode.SYSTEM_CONFIG_NO_ADMIN_USER),
