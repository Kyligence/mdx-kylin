...
public interface RepairFileService {
    ExcelFileDataSourceInfo checkDataSources(MultipartFile file) throws IOException;

    IOExceptionConsumer<OutputStream> repairFile(MultipartFile file) throws IOException;
}
