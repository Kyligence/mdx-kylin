...
then
  ...
  type="part"
  source_dirs=("diagnosis_tmp/conf_${query_time}" "diagnosis_tmp/logs_${query_time}" "diagnosis_tmp/schema_${query_time}" "diagnosis_tmp/dataset_${query_time}")
fi
...
tar -zcvf ./${dest_file_name} ./${intermediate_dir} >> /dev/null 2>&1
